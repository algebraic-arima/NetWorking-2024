...
// 		// "ip rule add from 10.0.0.0/24 table direct",
// 		"ip rule add from all lookup tun0",
// 		"ip route add default via 10.180.0.1 dev eth2 table direct",
// 	}
...
// 		"ip rule del from 10.0.0.0/24 table direct",
// 		"ip rule del from all lookup tun0",

// 		"ip route del default via 10.180.0.1 dev eth2 table direct",
// 		"ip route del default dev tun0 table tun0",
// 	}
